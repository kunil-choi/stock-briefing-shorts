...
BRIEFING_TYPE = _CFG.get("briefing_type", "shorts")
WINDOW_START  = (_CFG.get("window") or {}).get("start", "07:00")
WINDOW_END    = (_CFG.get("window") or {}).get("end", "08:00")
DURATION      = _CFG.get("duration") or {"min_seconds": 45, "max_seconds": 60}
